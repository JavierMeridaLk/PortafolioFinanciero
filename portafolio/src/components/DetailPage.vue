<template>
  <div class="flex flex-col min-h-full pb-20">
    <header class="sticky top-0 z-10 bg-black/10 backdrop-blur-lg md:px-20 md:pt-6 px-8 pt-8 pb-2.5">
    ...
    <div class="md:px-20 px-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 pt-5">
      <div v-for="item in stockData.cards" :key="item.title"
        ...
        <div class="flex justify-between items-center">
          <div class="flex flex-col gap-y-2">
            ...
            <code class="text-xl font-semibold flex items-center gap-x-4" :class="{
